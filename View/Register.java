...
public class Register{
    ...
    {   
        ...
        registerFrame.getContentPane().setBackground(new Color(114,128,255));
        registerButton.setBackground(Color.GREEN);
        loginButton.setBackground(Color.red);
        welcomeLabel.setFont(new Font("Arial",Font.BOLD,18));
        firstNameField.setFont(new Font("Arial",Font.PLAIN,17));
        lastNameField.setFont(new Font("Arial",Font.PLAIN,17));
        ...
        springLayout.putConstraint(SpringLayout.NORTH, passwordField, 43, SpringLayout.SOUTH, lastNameField);
        ...
        springLayout.putConstraint(SpringLayout.NORTH, emailIcon, 42, SpringLayout.SOUTH, passwordIcon);
        springLayout.putConstraint(SpringLayout.NORTH, phoneIcon, 42, SpringLayout.SOUTH, emailIcon);
        ...
        foot.setPreferredSize(new Dimension(400,80));
        ...
        foot.add(Box.createRigidArea(new Dimension(150,80)));
